...
CREATE TABLE AUTHORITIES (ID BIGINT PRIMARY KEY AUTO_INCREMENT, NAME VARCHAR(255));

DROP TABLE IF EXISTS USERS;
CREATE TABLE USERS (ID BIGINT PRIMARY KEY AUTO_INCREMENT, USERNAME VARCHAR(255), PASSWORD VARCHAR(255), DATE TIMESTAMP);

DROP TABLE IF EXISTS USERS_AUTHORITIES;
CREATE TABLE USERS_AUTHORITIES (USER_ID BIGINT, AUTHORITY_ID BIGINT,
